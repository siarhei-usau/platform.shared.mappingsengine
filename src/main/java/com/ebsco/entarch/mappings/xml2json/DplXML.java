...
public class DplXML extends XML{
...
//                                DplXML.stringToValue((String)token));
...
// Content, between <...> and </...>
                    ...
                    for (;;) {
                        ...
                        if (token == null) {
                            ...
                            if (string.length() > 0) {
//                                jsonobject.accumulate("#text",
//                                        DplXML.stringToValue(string));
                                jsonobject.accumulate("#text", string);
                            }
...
//                                            jsonobject.opt("#text"));
                                    ...
                                    // handle <elem id="id"></elem> with #text
                                    if (!jsonobject.has("#text")) {
                                        boolean attrOnly = true;
