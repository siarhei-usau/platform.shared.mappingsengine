...
import com.ebsco.platform.shared.mappingsengine.core.transformers.OriginalConcatJson
...
// test tests show what fails if you change to new OriginalConcatJson from OriginalOriginalConcatJson

class OriginalTranformTests : OriginalBasePathTest() {
    ...
    fun testCopyTransform_SingleValue() {
        ...
        CopyJson(queryPath, "@^c+renamed").apply(context)
        printJson(context.jsonObject)
    ...
    fun testCopyTransform_TargetIntoArray() {
        ...
        CopyJson(queryPath, "@^c+copied[+]").apply(context)
        printJson(context.jsonObject)
        ...
        CopyJson(safePath, "@^c^b^a.b[0].c+copied[+]").apply(context)
        printJson(context.jsonObject)
    ...
    fun testDeleteTransform() {
        ...
        DeleteJson(queryPath).apply(context)
        printJson(context.jsonObject)
    ...
    fun testConcatTransform_InSameObjects() {
        ...
        OriginalConcatJson(fromPaths, ", ", "$.people[*]+fullname").apply(context)
        printJson(context.jsonObject)
    ...
    fun testConcatTransform_MixedObjectConcat_AbsoluteTarget() {
        ...
        CopyJson("$.states[*].name", "@^states+cities[*].stateName").apply(context)
        ...
        OriginalConcatJson(fromPaths, ", ", "$.states[*].cities[*]+cityState").apply(context)
        printJson(context.jsonObject, "After Concat")

        DeleteJson("$.states[*].cities[*].stateName")
    ...
    fun testConcatTransform_MixedObjectConcat_RelativeTarget() {
        ...
        OriginalConcatJson(fromPaths, ", ", "@^cities+cityState").apply(context)
        printJson(context.jsonObject, "After Concat")
    ...
    fun testConcatTransform_MultipleOfSameIntoSingle_absoluteTarget() {
        ...
        // need absolute target path here because the from nodes are at different levels
        OriginalConcatJson(fromPaths, ", ", "$.states[*]+cityList").apply(context)
        printJson(context.jsonObject, "After Concat")
    ...
    fun testConcatTransform_MultipleOfSameIntoSingle_relativeTarget() {
        ...
        // need absolute target path here because the from nodes are at different levels
        OriginalConcatJson(fromPaths, ", ", "@^cities^states+cityList").apply(context)
        printJson(context.jsonObject, "After Concat")
    ...
    fun testCopyTransform_MultipleOfSameIntoSingle_absoluteTarget() {
        ...
        // need absolute target path here because the from nodes are at different levels
        CopyJson("$.states[*].cities[*].name", "$.states[*]+cityList[+]").apply(context)
        printJson(context.jsonObject, "After Concat")
    ...
    fun testCopyTransform_MultipleOfSameIntoSingle_relativeTarget() {
        ...
        // need absolute target path here because the from nodes are at different levels
        CopyJson("$.states[*].cities[*].name", "@^cities^states+cityList[+]").apply(context)
        printJson(context.jsonObject, "After Concat")
